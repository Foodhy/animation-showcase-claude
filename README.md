...
A curated gallery of **48 self-contained animation demos** covering scroll choreography, 3D/WebGL scenes, View Transitions API, CSS/Canvas effects, and full-page experiences. Built with GSAP, Three.js, Lenis, and modern web standards.
