...
A curated gallery of **35 self-contained animation demos** covering scroll choreography, 3D/WebGL scenes, View Transitions API, CSS/Canvas effects, and full page builds. Built with GSAP, Three.js, Lenis, and modern web standards.
...
- **Vite-bundled demos** (25): Have a `.vite-demo` marker file. Use `import` statements for npm packages (GSAP, Three.js, Lenis). Vite auto-discovers them via `vite.config.js`.
...
├── demos/
│   ├── registry.json       # Metadata for all 35 demos
