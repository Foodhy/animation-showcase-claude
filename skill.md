...
**stealthisdesign** is a curated gallery of 48 web animation demos across 5 categories: scroll animations, 3D/WebGL, View Transitions, CSS/Canvas effects, and full page builds. Each demo is a self-contained example of a specific animation technique. Anyone can view and modify any project to their liking — all open source.
